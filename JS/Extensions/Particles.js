...
function drawParticles(pic, x, y, frequency, num, sizeX, sizeY, movement, duration) { // Function for creating particles (visual effects) and moving them
...
function particleClass(pic, x, y, duration, movement) { // Function for manipulating the particles and running them
